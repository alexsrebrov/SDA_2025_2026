...
3. [Kth Closest Points To Origin](https://leetcode.com/problems/k-closest-points-to-origin/description/)
4. [Task Scheduler](https://leetcode.com/problems/task-scheduler/description/)
5. [Фитнес зала](https://www.hackerrank.com/contests/sda-test4-2022-2023-343rrsdfs/challenges/challenge-3768/problem)
6. [Рожден ден](https://www.hackerrank.com/contests/sda-hw-8-2023/challenges/two-pqs/problem)
7. [Merge K Sorted Linked Lists](https://leetcode.com/problems/merge-k-sorted-lists/description/)
8. [Търчащата медиана](https://www.hackerrank.com/contests/sda-20232024-test-4/challenges/challenge-4442/problem)
